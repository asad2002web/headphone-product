            ...
            <div className=''>
                ...
                <form className='border-[#8b4a2e] border-y-[16px] border-x-[6px] border-b-[6px] rounded-2xl grid grid-cols-2'>
                    <ul className='py-6 ps-4'>
                        ...
                        <li>
                            <label htmlFor="নম্বর">নম্বর লিখুন <span className='text-[#FF0000] text-lg font-bold'>*</span></label><br />
                    ...
                    <ul className='py-6 px-10'>
                        ...
                        <li>
                            <div className='py-5 ps-5 my-5 rounded-md bg-[#f7f7f7]'>Cash on delivery
